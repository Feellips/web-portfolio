...
export default class Preloader extends EventEmitter {
    ...
    setAssets() {
        convert(document.querySelector(".intro-text") as HTMLElement);
        convert(document.querySelector(".hero-main-title") as HTMLElement);
        convert(document.querySelector(".hero-main-description") as HTMLElement);
        convert(document.querySelector(".hero-second-subheading") as HTMLElement);
        convert(document.querySelector(".second-sub") as HTMLElement);
